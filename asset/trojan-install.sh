...
if [[ $TYPE == 0 ]];then
    ...
    CHECKVERSION="https://api.github.com/repos/dcbsg/trojan-go/releases" #p4gefau1t
fi
NAME=trojan
...
if [[ $TYPE == 0 ]];then
    ...
    DOWNLOADURL="https://github.com/dcbsg/trojan-go/releases/download/v$VERSION/$TARBALL" #p4gefau1t
fi
